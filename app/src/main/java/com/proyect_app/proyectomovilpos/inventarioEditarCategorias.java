...
public class inventarioEditarCategorias extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_inventario_editar_categorias);
        ...
        Button btnBack18 = (Button) findViewById(R.id.btnBack18);

        btnBack18.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(inventarioEditarCategorias.this, inventarioEditar.class);
