...
public class inventarioEditarProductos extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_inventario_editar_productos);
        ...
        Button btnBack19 = (Button) findViewById(R.id.btnBack19);

        btnBack19.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(inventarioEditarProductos.this, inventarioEditar.class);
