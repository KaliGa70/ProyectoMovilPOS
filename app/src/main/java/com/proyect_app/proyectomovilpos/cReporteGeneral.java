...
public class cReporteGeneral extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_creporte_general);
        ...
        Button btnBack15 = (Button) findViewById(R.id.btnBack15);

        btnBack15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(cReporteGeneral.this, cControl.class);
